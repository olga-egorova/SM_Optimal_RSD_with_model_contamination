...
#### scaling parameter of the prior variance, squared; tau2 = 1./Q in the manuscript. 
tau2<-1.0/Q                                 
tau<-tau2^0.5
...
seeds = c(4538, 35106, 21920, 4845, 91214, 7907)
...
for (k in 1:nrow(m.kappa)){   # might choose a subset of weights
  ...
  save.image("output/workspaces/MSEB_Q_search.RData")
  write.csv(df.output, "output/tables/MSEB_Q_values.csv")
...
writexl::write_xlsx(design_list, "output/designs/MSEDB_Q_designs.xlsx")

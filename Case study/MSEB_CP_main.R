...
seeds = c(4802, 71355, 93647, 26162, 53700, 59672)
...
for (k in 1:nrow(m.kappa)){   # might choose a subset of weights
  ...
  save.image("output/workspaces/MSEB_CP_search.RData")
  write.csv(df.output, "output/tables/MSEB_CP_values.csv")
...
writexl::write_xlsx(design_list, "output/designs/MSEB_CP_designs.xlsx")

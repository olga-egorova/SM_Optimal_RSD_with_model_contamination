...
Biter<-500       # Number of MC iterations for the mse(D) component evaluation
...
seeds = c(38488, 55516, 33203, 24440, 195429, 119140, 84343, 79272, 49256, 11978)
...
for (k in 1:nrow(m.kappa)){  
  ...
  save.image("output/workspaces/MSE_LP_search.RData")
  
  write.csv(df.output, "output/tables/MSELP_values.csv")
...
writexl::write_xlsx(design_list, "output/designs/MSE_LP_designs.xlsx")

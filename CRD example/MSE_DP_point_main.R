...
seeds = c(74361, 69159, 145834, 24952, 142243, 48086, 71671, 63365, 65436, 55676)
...
for (k in 1:nrow(m.kappa)){   
  ...
  save.image("output/workspaces/MSEDP_point.RData")
  write.csv(df.output, "output/tables/MSEDP_point_values.csv")
...
writexl::write_xlsx(design_list, "output/designs/MSEDP_point_designs.xlsx")
